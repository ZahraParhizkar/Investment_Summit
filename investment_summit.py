...
col1, col2 = st.columns([5, 1])  # ستون سمت راست بزرگتر
with col1:
...
روز اول: 
امکان سنجی از نظر فنی (برآورد هزینه)

روز دوم: 
امکان سنجی از نظر بازار (برآورد فروش)

روز سوم: 
امکان سنجی از نظر مالی (ارزیابی اقتصادی طبق داده های بدست آمده از هزینه-فروش)
